...
from point_matchers.DKM.dkm.utils import get_tuple_transform_ops
from einops import rearrange
from point_matchers.DKM.dkm.utils.local_correlation import local_correlation
...
class RegressionMatcher(nn.Module):
    ...
    def sample(
        ...
        from point_matchers.DKM.dkm.utils.kde import kde
